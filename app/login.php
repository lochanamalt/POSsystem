...
if(isset($_SESSION["exist"])){
...
else if(isset($_POST['email']) && isset($_POST['pword'])) {
    ...
    $resultSet = $connection->query("SELECT password FROM login WHERE e_mail='$email'");
    ...
    if($pw===$password){
        ...
        session_unset(); //save una ewa ain karanna.
        session_destroy();
    }
}
?>
